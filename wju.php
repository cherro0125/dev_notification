...
if(isset($_POST['wydzial'])){
		...
		echo '<form method="post">';
  		echo '<select name="wydzialy">';
		echo '<option value="Red County Sheriff's Department</font>">Red County Sheriff's Department</option>';
    	echo '<option value="Los Santos Police Department">Los Santos Police Department</option>';
  	    echo '</select>';
  		echo '<input type="submit" name="zatwierdz_wydzial" value="Zatwierdz">';
		echo '</form>';
